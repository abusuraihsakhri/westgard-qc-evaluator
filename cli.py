"""
Command Line Interface for Westgard Qc Evaluator.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="westgard-qc-evaluator", description="Westgard Qc Evaluator")
    ...
    if args.command == "serve":
        ...
        print(f"Starting Westgard Qc Evaluator API server on http://{args.host}:{args.port}")
